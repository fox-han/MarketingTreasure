...
/** 纯文字类型 */
@property (nonatomic, strong) NSArray *typeGroup;
...
//新增
/** 类型字体颜色 */
@property (nonatomic, strong) UIColor *typeLabelTextColor;

/** 类型字体大小 */
@property (nonatomic, strong) UIFont  *typeLabelTextFont;

/** 类型背景颜色 */
@property (nonatomic, strong) UIColor *typeLabelBackgroundColor;
