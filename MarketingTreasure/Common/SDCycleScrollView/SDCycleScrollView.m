...
- (void)setTypeGroup:(NSArray *)typeGroup
{
...
//            [cell.imageView sd_setImageWithURL:[NSURL URLWithString:imagePath] placeholderImage:self.placeholderImage];
    ...
    if (_titlesGroup.count && itemIndex < _titlesGroup.count) {
        ...
        cell.type = _typeGroup[itemIndex];
    }
    ...
    if (!cell.hasConfigured) {
        ...
        cell.typeLabelTextFont = self.typeLabelTextFont;
        cell.typeLabelTextColor = self.typeLabelTextColor;
        cell.typeLabelBackgroundColor = self.typeLabelBackgroundColor;
